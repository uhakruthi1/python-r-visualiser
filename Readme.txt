...
--A full-stack web application where users can write and execute Python or R code to generate visual plots — right in the browser! Supports light/dark themes, inline Monaco Editor, and dynamic rendering of plots via Docker containers.
